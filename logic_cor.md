...
**Preuve.** Puisque $$P$$ et $$Q \lor \overline P$$ sont vraies, leur conjonction l'est aussi. On a donc $$P \land (Q \lor \overline P)$$ vraie. Par distribution, $$P \land (Q \lor \overline P) \iff (P \land Q) \lor (P \land \overline{P})$$. Comme $$P \land \overline{P}$$ est toujours fausse, on a au final $$P \land (Q \lor \overline P) \iff (P \land Q)$$ et cette dernière expression est vraie par hypothèse. Mais $$\overline{Q} \implies \overline{P} \lor \overline{Q}$$ soit $$\overline{Q} \implies \overline{P \land Q}$$. Comme $$\overline{P \land Q}$$, on en déduit par l'absurde que $$Q$$ est vraie.
