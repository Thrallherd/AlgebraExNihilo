...
On dit que l'ensemble $$c$$ est une **carte** de l'ensemble $$a$$ vers l'ensemble $$b$$ si $$c \subseteq a \times b$$ et si pour tout ensemble $$x \in a$$ et $$y, z \in b$$, on a l'implication « $$(x, y) \in c \land (x, z) \in c \implies y = z$$ ».
